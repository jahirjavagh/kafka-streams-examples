...
public class ReduceTest {
  ...
  public void shouldConcatenate() {
    ...
    try (final TopologyTestDriver testDriver = new TopologyTestDriver(builder.build(), streamsConfiguration)) {
      ...
      UnitTestKit.writeRecordsToTopic(testDriver, inputTopic, inputRecords, new IntegerSerializer(), new StringSerializer());

      // Step 3: Validate the output
      final Map<Integer, String> actualOutput =
          UnitTestKit.readTopicAsMap(testDriver, outputTopic, new IntegerDeserializer(), new StringDeserializer());
